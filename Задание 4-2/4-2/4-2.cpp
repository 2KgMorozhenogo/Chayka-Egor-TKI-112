...
void replacement(int n, int i, int *arr) // функция поиска минимального элемента и замены его на средний
{
	...
	cout << "Массив после замены минимального элемента на средний - ";
	for (i = 0; i < n; i++)
	{
		cout << arr[i] << " " ;
	}
...
void burn(int n, int i, int *arr) // функция поиска элементов массива в записи которых есть цифра 5 и замена их на 0
{
	...
	cout << endl << "Массив после удаления элементов с цифрой 5 в записи - ";
	for (i = 0; i < n; i++)
	{
		cout << arr[i] << " ";
	}
...
int main()
{
	...
	cin >> n;
	cout << "Как хотите заполнить массив? Введите 1 для ручного заполнения. Введите 2 для заполнения случайными числами - ";
	cin >> a;
